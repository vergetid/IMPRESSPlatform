...
import eu.impress.impressplatform.IntegrationLayer.ResourcesMgmt.BeansTransformationBean;
import eu.impress.impressplatform.IntegrationLayer.ResourcesMgmt.BedsServiceBean;
...
public class BedsAvailabilityQueryController {
	@Autowired
	private BedsServiceBean bedService;
	@Autowired
	private BeansTransformationBean beansTransformation;
	...
	public ResponseEntity<String> getAvailableBedsXML(@RequestParam("hospital") String hospitalName) {	
		eu.impress.impressplatform.Models.DHC.BedStats bedStats = bedService.getHospitalAvailableBeds(hospitalName);
		if (bedStats == null) {
